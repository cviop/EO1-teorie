...
\href[pdfnewwindow=true]{http://hippo.feld.cvut.cz/vyuka/soubory/ElektronickeObvody.pdf#subsection.7.3.1}{Odkaz na odpovídající kapitolu v Hospodkových skriptách}
\begin{figure}[h!]
    \centering
    \includegraphics[width=.8\textwidth]{prechodova_odezva.PNG}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=.8\textwidth]{impusni_odezva.PNG}
...
\href[pdfnewwindow=true]{http://hippo.feld.cvut.cz/vyuka/soubory/ElektronickeObvody.pdf#subsection.7.3.2}{Odkaz na odpovídající kapitolu v Hospodkových skriptách}
...
\href[pdfnewwindow=true]{http://hippo.feld.cvut.cz/vyuka/soubory/systemy.pdf#page.15}{Odkaz na odpovídající kapitolu v Hospodkových skriptách}
...
\href[pdfnewwindow=true]{http://hippo.feld.cvut.cz/vyuka/soubory/filtry_prenosy.pdf#page.18}{Odkaz na odpovídající kapitolu v Hospodkových skriptách}
...
\href[pdfnewwindow=true]{http://hippo.feld.cvut.cz/vyuka/soubory/filtry_synteza.pdf#page.23}{Odkaz na odpovídající kapitolu v Hospodkových skriptách}
...
\href[pdfnewwindow=true]{http://hippo.feld.cvut.cz/vyuka/soubory/ElektronickeObvody.pdf#section.10.1}{Odkaz na odpovídající kapitolu v Hospodkových skriptách}
...
\href[pdfnewwindow=true]{http://hippo.feld.cvut.cz/vyuka/soubory/ElektronickeObvody.pdf#subsection.10.8.4}{Odkaz na odpovídající kapitolu v Hospodkových skriptách}
...
\href[pdfnewwindow=true]{http://hippo.feld.cvut.cz/vyuka/soubory/ElektronickeObvody.pdf#section.11.3}{Odkaz na odpovídající kapitolu v Hospodkových skriptách}
...
\href[pdfnewwindow=true]{http://hippo.feld.cvut.cz/vyuka/soubory/ElektronickeObvody.pdf#section.11.5}{Odkaz na odpovídající kapitolu v Hospodkových skriptách}
...
\href[pdfnewwindow=true]{http://hippo.feld.cvut.cz/vyuka/soubory/ElektronickeObvody.pdf#section.11.9}{Odkaz na odpovídající kapitolu v Hospodkových skriptách}
...
\href[pdfnewwindow=true]{http://hippo.feld.cvut.cz/vyuka/soubory/ElektronickeObvody.pdf#section.11.8}{Odkaz na odpovídající kapitolu v Hospodkových skriptách}
...
\href[pdfnewwindow=true]{http://hippo.feld.cvut.cz/vyuka/soubory/ElektronickeObvody.pdf#section.11.10}{Odkaz na odpovídající kapitolu v Hospodkových skriptách}
...
\href[pdfnewwindow=true]{http://hippo.feld.cvut.cz/vyuka/soubory/zv.pdf#page.29}{Odkaz na odpovídající kapitolu v Hospodkových skriptách}
...
\href[pdfnewwindow=true]{http://hippo.feld.cvut.cz/vyuka/soubory/ElektronickeObvody.pdf#section.11.16}{Odkaz na odpovídající kapitolu v Hospodkových skriptách}
...
\href[pdfnewwindow=true]{http://hippo.feld.cvut.cz/vyuka/soubory/ElektronickeObvody.pdf#section.11.18}{Odkaz na odpovídající kapitolu v Hospodkových skriptách}
...
\label{chap:komp}
\href[pdfnewwindow=true]{http://hippo.feld.cvut.cz/vyuka/soubory/ElektronickeObvody.pdf#section.11.19}{Odkaz na odpovídající kapitolu v Hospodkových skriptách}
...
%17
\section{Nakreslete principiální zapojení obvodu S\&H (Sample and Hold) s~OZ a~popište jeho funkci, výhody/ nevýhody a~použití.}\href[pdfnewwindow=true]{http://hippo.feld.cvut.cz/vyuka/soubory/ElektronickeObvody.pdf#section.11.15}{Odkaz na odpovídající kapitolu v Hospodkových skriptách}
...
\href[pdfnewwindow=true]{http://hippo.feld.cvut.cz/vyuka/soubory/ElektronickeObvody.pdf#subsection.14.5.1}{Odkaz na odpovídající kapitolu v Hospodkových skriptách}
...
\href[pdfnewwindow=true]{http://hippo.feld.cvut.cz/vyuka/soubory/ElektronickeObvody.pdf#subsection.14.5.3}{Odkaz na odpovídající kapitolu v Hospodkových skriptách}
\begin{figure}[h!]
    \centering
...
\href[pdfnewwindow=true]{http://hippo.feld.cvut.cz/vyuka/soubory/ElektronickeObvody.pdf#subsection.14.5.5}{Odkaz na odpovídající kapitolu v Hospodkových skriptách}
\begin{figure}[h!]
    \centering
...
\href[pdfnewwindow=true]{http://hippo.feld.cvut.cz/vyuka/soubory/ElektronickeObvody.pdf#subsection.14.5.2}{Odkaz na odpovídající kapitolu v Hospodkových skriptách}
...
\href[pdfnewwindow=true]{http://hippo.feld.cvut.cz/vyuka/soubory/ElektronickeObvody.pdf#subsection.14.5.4}{Odkaz na odpovídající kapitolu v Hospodkových skriptách}
\begin{figure}[h!]
    \centering
...
\href[pdfnewwindow=true]{http://hippo.feld.cvut.cz/vyuka/soubory/ElektronickeObvody.pdf#subsection.14.5.6}{Odkaz na odpovídající kapitolu v Hospodkových skriptách}
\begin{figure}[h!]
    \centering
