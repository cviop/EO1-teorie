...
\lhead{verze \today,~\currenttime}       \chead{} \rhead{\url{github.com/cviop/EO1-teorie}}                        %pole zahlavi (prazdna)
...
\href[pdfnewwindow=true]{http://hippo.feld.cvut.cz/vyuka/soubory/ElektronickeObvody.pdf#subsection.14.5.1}{Odkaz na odpovídající kaopitolu v Hospodkových skriptách}
...
\href[pdfnewwindow=true]{http://hippo.feld.cvut.cz/vyuka/soubory/ElektronickeObvody.pdf#subsection.14.5.3}{Odkaz na odpovídající kaopitolu v Hospodkových skriptách}
\begin{figure}[h!]
    \centering
...
\href[pdfnewwindow=true]{http://hippo.feld.cvut.cz/vyuka/soubory/ElektronickeObvody.pdf#subsection.14.5.5}{Odkaz na odpovídající kaopitolu v Hospodkových skriptách}
\begin{figure}[h!]
    \centering
...
\href[pdfnewwindow=true]{http://hippo.feld.cvut.cz/vyuka/soubory/ElektronickeObvody.pdf#subsection.14.5.2}{Odkaz na odpovídající kaopitolu v Hospodkových skriptách}
...
\href[pdfnewwindow=true]{http://hippo.feld.cvut.cz/vyuka/soubory/ElektronickeObvody.pdf#subsection.14.5.4}{Odkaz na odpovídající kaopitolu v Hospodkových skriptách}
\begin{figure}[h!]
    \centering
...
\href[pdfnewwindow=true]{http://hippo.feld.cvut.cz/vyuka/soubory/ElektronickeObvody.pdf#subsection.14.5.6}{Odkaz na odpovídající kaopitolu v Hospodkových skriptách}
\begin{figure}[h!]
    \centering
